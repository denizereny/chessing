...
function bilgiGuncelle() {
  ...
  if (oyunBitti) {
    ...
    if (currentPlayerDisplay) currentPlayerDisplay.textContent = winner;
    ...
    if (currentPlayerDisplay) currentPlayerDisplay.textContent = statusText;
...
function updateColorPreviews() {
  // Update preview squares
  const lightPreview = document.querySelectorAll('.light-preview');
  const darkPreview = document.querySelectorAll('.dark-preview');
  
  lightPreview.forEach(el => {
    el.style.backgroundColor = document.getElementById('lightSquareColor').value;
  });
  
  darkPreview.forEach(el => {
    el.style.backgroundColor = document.getElementById('darkSquareColor').value;
  });
}
...
function applyColorPreset(presetName) {
  ...
  bildirimGoster(`${presetName.charAt(0).toUpperCase() + presetName.slice(1)} preset applied!`);
}
...
function loadColorSettings() {
  ...
  if (saved) {
    try {
      ...
      // Update inputs
      if (document.getElementById('lightSquareColor')) {
        document.getElementById('lightSquareColor').value = settings.lightSquare || '#f0d9b5';
        document.getElementById('lightSquareHex').value = settings.lightSquare || '#f0d9b5';
        document.getElementById('darkSquareColor').value = settings.darkSquare || '#b58863';
        document.getElementById('darkSquareHex').value = settings.darkSquare || '#b58863';
        document.getElementById('whitePieceColor').value = settings.whitePiece || '#ffffff';
        document.getElementById('whitePieceHex').value = settings.whitePiece || '#ffffff';
        document.getElementById('blackPieceColor').value = settings.blackPiece || '#2c2c2c';
        document.getElementById('blackPieceHex').value = settings.blackPiece || '#2c2c2c';
...
// Load color settings when page loads
